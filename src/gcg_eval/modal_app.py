...
image = (
    ...
    .add_local_python_source("gcg_eval")
)
...
def run_pgd_eval(
    ...
    from gcg_eval.config import Config
    from gcg_eval.pgd_suffix import PGDSuffixOptimizer
...
def main(
    mode: str = "pgd",
    train_data_path: str = "../consistency-training/evolutionary-consistency/data/sycophancy_train.jsonl",
    eval_data_path: str = "../consistency-training/evolutionary-consistency/data/sycophancy_eval.jsonl",
    num_steps: int = 2000,
    ...
    Usage:
        modal run --detach src/gcg_eval/modal_app.py --num-steps 2000 --suffix-length 100 --limit 500
        modal run --detach src/gcg_eval/modal_app.py --mode pgd-eval --pgd-suffix "your suffix here" --limit 50
    """
    import json
